...
const BasePage = function (customAudio = null) {
  ...
  this.signin = async function() {
    ...
    const inputUserNameJs = "document.querySelector(`*[slot='globalheader']`).getElementsByClassName('sub2').item(0).children[0].value='8006695202'"
    await this.driver.executeScript(inputUserNameJs); 
    const inputPasswordJs = "document.querySelector(`*[slot='globalheader']`).getElementsByClassName('sub2').item(0).children[1].value = 'Delta999'"
